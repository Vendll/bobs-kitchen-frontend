...
const features = [
  ...
  },
  {
    ...
    description:
      'We design every detail with the best materials and finishes. This laptop sleeve features durable canvas with double-stitched construction, a felt interior, and a high quality zipper that hold up to daily use.',
    imageSrc: '/image2/image00002.jpeg',
    imageAlt: 'Detail of zipper pull with tan leather and silver rivet.',
  },
]
          ...
          <div className="border-b border-gray-200">
            <div className="h-24 flex items-center justify-between">
              ...
              <div className="flex-1 flex items-center justify-end">
                ...
                {/* Search */}
                <a href="#" className="hidden ml-6 p-2 text-gray-400 hover:text-bobgray lg:block">
                  <span className="sr-only">Search</span>
                  <SearchIcon className="w-6 h-6" aria-hidden="true" />
                </a>

                {/* Account */}
                <a href="#" className="p-2 text-gray-400 hover:text-bobgray lg:ml-4">
    ...
    <div className="relative bg-white mt-24">
      ...
      <div className="relative pt-12 pb-16 px-4 sm:pt-16 sm:px-6 lg:px-8 lg:max-w-7xl lg:mx-auto lg:grid lg:grid-cols-2">
        <div className="lg:col-start-2 lg:pl-8">
          <div className="text-base  mx-auto lg:max-w-lg lg:ml-auto lg:mr-0">
            <h2 className="leading-6 text-bobred font-semibold tracking-wide uppercase">Work with us</h2>
    ...
    <div className="relative py-24">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-extrabold tracking-tight text-bobblue sm:text-4xl">Protect your device</h2>
      ...
      <div className="max-w-7xl mx-auto py-12 mt-20 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
          {footnavigation.main.map((item) => (
            <div key={item.name} className="px-5 py-2">
              <a href={item.href} className="text-base text-bobblue hover:text-bobred">
                {item.name}
              </a>
            </div>
          ))}
        ...
        <div className="mt-8 flex justify-center space-x-6">
          {footnavigation.social.map((item) => (
            <a key={item.name} href={item.href} className="text-bobblue hover:text-bobred">
